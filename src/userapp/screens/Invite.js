  ...
  return (
    <View style={styles.container}>
      <View style={{ backgroundColor: "#adb4f6cc", padding: 20 }}>
        ...
        {user?.referralCode ?
          <Text style={{ color: "darkred", fontSize: 18, fontWeight: "bold", marginTop: 10 }} onPress={() => {
            const playStoreLink =
              user?.referralCode; // Replace with your app's actual Play Store link
        ...
        <View style={{ flexDirection: "row", justifyContent: "center" }}>
          <View style={styles.inviteicon}>
            <MaterialCommunityIcons
              ...
              onPress={() => {
                const playStoreLink =
                  `Hey! Check out this awesome app, Vijay Home Services. Install it now and use my referral code ${user?.referralCode} to get a special discount!`; // Replace with your app's actual Play Store link
                Clipboard.setString(playStoreLink);
                alert("Play Store link copied to clipboard!");
              }}
            />
      ...
      {modalVisible  ?
        ...
        <View style={{ position: "absolute", bottom: 10, flex: 1, width: "100%" }}>
          <Shimmer duration={500} pauseDuration={1000} tilt={50}>
            <TouchableOpacity style={styles.claim} onPress={() => setModalVisible(true)}>
              <Text style={{ color: "black", fontWeight: "700", fontSize: 16 }}>Redeem</Text>
            </TouchableOpacity></Shimmer>
        </View>
      }
              ...
              <View >
                ...
                <TextInput
                  ...
                  underlineColorAndroid={
                    Platform.OS === "android" ? "your_color_here" : null
                  }
                ...
                <View style={{ justifyContent: "center", alignItems: "center" }}>
                  ...
                  <TouchableOpacity onPress={() => setModalVisible(false)} style={styles.logintext1}>
                    <Text
                      style={{
                        textAlign: "center",
                        color: "white",
