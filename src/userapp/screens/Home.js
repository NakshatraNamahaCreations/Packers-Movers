...
function Home({navigation}) {
  ...
  const [CityModalVisible, setCityModalVisible] = useState(true);
            ...
            {/* <View style={{ margin: 15 }}>
              <ImageSliderF
                ...
                indicatorContainerStyle={{
                  ...
                  alignItems: "center",
                  bottom: 10,
                  opacity: 1, // Change opacity to 1 instead of 10
                }}
                // onClick={(item, index) => { navigation.navigate("repairing",{cdata:sdata.filter((i)=>i.subcategory === item?.subcategory)}) }}
            ...
            {postcategorydata.length > 0 ? (
              <FlatList
                data={postcategorydata
                  ...
                  .sort(
                    (a, b) =>
                      parseInt(a.order.trim()) - parseInt(b.order.trim()),
                  )}
                numColumns={4}
