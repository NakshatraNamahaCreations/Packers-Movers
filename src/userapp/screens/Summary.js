...
} from '../screens/Redux/MyCartSlice';
import LottieView from 'lottie-react-native';
import {deleteMyCartItemaddon} from '../screens/Redux1/MyCartSlice'; // Adjust the path as needed
...
function Summary({navigation}) {
  ...
  const checkTransactionStatus = async () => {
    ...
    try {
      const config = {
        url: `/payment/status/${merchantId}/${Transaction}/${user._id}/${sdata._id}`,
        method: 'post',
        baseURL: 'https://api.vijayhomeservicebengaluru.in/api',
        headers: {'content-type': 'application/json'},
        data: {},
                          ...
                          <View style={{flexDirection: 'row'}}>
                            ...
                            <Text
                              ...
                              {total
                                ...
                                : couponDiscount - parseInt(discountAmount)}
                            </Text>
                          </View>
                        </View>
                      </View>
