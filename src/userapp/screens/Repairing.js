...
import {
  ...
  removeMyCartItem,
  clearCart,
} from '../screens/Redux1/MyCartSlice';
import {deleteMyCartItem} from '../screens/Redux1/MyCartSlice'; // Adjust the path as needed
...
function Repairing({navigation}) {
  ...
  const videoSource = `https://api.vijayhomesuperadmin.in/subcat/${cdata?.subcatvideo}`;
  ...
  useEffect(() => {
    ...
    Animated.timing(fadeAnimation, {
      toValue: 1, // 1 means fully opaque
      duration: 1000, // Duration of the animation in milliseconds
      easing: Easing.ease, // Easing function (you can adjust this)
      ...
      {isLoading ? (
        ...
        <View>
          <ScrollView
            ...
            />
            {/* <VideoPlayer
              video={{ uri: 'https://vz-0ebc8124-b6c.b-cdn.net/90c2b379-dffc-4bb7-9f92-340bfe341e46/playlist.m3u8' }}
              videoWidth={1600}
              videoHeight={900}
            ...
            <View style={{margin: 10}}>
              ...
              <View
                ...
                <View style={{flexDirection: 'row', marginTop: 8}}>
                  ...
                  <Text style={{color: 'black', fontSize: 16, marginTop: 2}}>
                    {' '}
                    (9.1T)
                  </Text>
                </View>
                      ...
                      {slicedData.map((i) => (
                        ...
                        >
                          ...
                          <View style={{ flex: 0.8 }}>
                            ...
                            <Text style={{ marginTop: 5, color: "black", fontWeight: "bold", textDecorationLine: "underline" }}>
                              {i.customerName}
                            </Text>
                            <Text style={{ marginTop: 10, color: "black" }}>
                              {i.review}
                            </Text>
                            <Text style={{ marginTop: 10, color: "black", textAlign: "right" }}>
